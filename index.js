...
function addGamesToPage(games) {
    ...
    for(let game in games){
        ...
        gameCard.innerHTML = `Name:${game.name} 
...
const unfundedGames = `A total of $${amountRaised.toLocaleString('en-US')} has been raised for 4 games. 
Currently, ${unfundedGamesCount.length > 1 ? unfundedGamesCount.length : 1} games remains
unfunded. We need your help to fund these amazing games.`;

// create a new DOM element containing the template string and append it to the description container
const description = document.createElement('p');
description.innerHTML = `${unfundedGames}`;
